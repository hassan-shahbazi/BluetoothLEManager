#
#  Be sure to run `pod spec lint BLEManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://hassaniiii@bitbucket.org/iosAdditional/ble-manager.git", :branch => "dev" }
  ...
  s.author             = "Hassan Shahbazi"
  s.social_media_url   = "https://www.linkedin.com/in/hassanshahbazi/"
